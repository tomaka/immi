...
//!
//! The whole context's area' is then filled with this image. The corners will always keep their
...
//!
//! The `left_border_percent` parameter is used to determine the percentage of the area that
